...
export default class LinkWidgetExt extends RJD.LinkWidget {
    ...
    constructor(props) {
        ...
        // console.log("LinkWidgetExt::link=",this.props.link);
    }
    ...
    generateLink(extraProps) {
        ...
        // console.log("LinkWidgetExt::generateLink.color=",link.color);
    ...
    drawAdvancedLine() {
        ...
        const paths = ds.map((data, index) => this.generateLink({
            ...
            onMouseDown: event => {
                if (!event.shiftKey) {
                    const point = new RJD.PointModel(link, diagramEngine.getRelativeMousePoint(event));
